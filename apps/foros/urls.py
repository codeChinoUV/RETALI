...
from apps.foros.views import participar_en_foro, responder_participacion, \
    ListarForosMaestroView, ListarForosAlumnoView, CrearForoView, ModificarForo, ConsultarForoView
