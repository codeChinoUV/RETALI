...
from apps.clases.views import registrar_clase, informacion_clase, unirse_clase, informacion_clase_alumno
...
urlpatterns = [
    ...
    path('<str:codigo_clase>/', informacion_clase_alumno, name='ver_materiaAlumno'),
